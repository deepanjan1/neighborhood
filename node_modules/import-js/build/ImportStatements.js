...
var _lodash3 = require('lodash.partition');
...
var GROUPINGS_ARRAY = Object.freeze((0, _lodash2['default'])(STYLES.map(function (style) {
  ...
  _createClass(ImportStatements, [{
    ...
    value: function () {
      function push() {
        ...
        importStatements.forEach(function (importStatement) {
          var existingStatement = _this2.imports[importStatement.path];
          if (existingStatement) {
            ...
            _this2.imports[importStatement.path] = importStatement;
          }
        });
        ...
        this._toGroups().forEach(function (group) {
          group.forEach(function (importStatement) {
            var importStrings = importStatement.toImportStrings(maxLineLength, tab).map(function (importString) {
              return _this4.config.get('importStatementFormatter', {
    ...
    value: function () {
      function _toGroups() {
        ...
        var result = (0, _lodash4['default'])(importsArray, function (importStatement) {
          return !importStatement.isParsedAndUntouched();
        });
        result = (0, _lodash2['default'])(result);
        result = (0, _lodash6['default'])(result, function (is) {
          return is.toNormalized();
        });
        result = (0, _lodash8['default'])(result, function (is) {
          return is.toNormalized();
        });
