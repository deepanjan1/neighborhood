...
var _program$command, _program$command2, _program$command3, _program$command4;
...
(_program$command2 = _commander2['default'].command('fix <pathToFile>')).option.apply(_program$command2, _toConsumableArray(sharedOptions.overwrite)).action(function (pathToFile, options) {
  var executor = function executor(importer) {
...
(_program$command3 = _commander2['default'].command('rewrite <pathToFile>')).option.apply(_program$command3, _toConsumableArray(sharedOptions.overwrite)).action(function (pathToFile, options) {
  var executor = function executor(importer) {
...
(_program$command4 = _commander2['default'].command('add <imports> <pathToFile>')).option.apply(_program$command4, _toConsumableArray(sharedOptions.overwrite)).action(function (imports, pathToFile, options) {
  var executor = function executor(importer) {
...
_commander2['default'].command('start').description('start a daemon').option('--parent-pid <n>', parseInt).action(function (_ref2) {
  var parentPid = _ref2.parentPid;
...
_commander2['default'].on('--help', function () {
  var examples = ['word someModule path/to/file.js', 'fix path/to/file.js', 'rewrite --overwrite path/to/file.js', 'add \'{ "foo": "path/to/foo", "bar": "path/to/bar" }\' path/to/file.js', 'goto someModule path/to/file.js', 'cachepath', 'logpath', 'start --parent-pid=12345'];
